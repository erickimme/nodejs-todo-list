...
// 검증할 데이터를 정의합니다.
// const user = { name: 'Foo Badfdafdfasdfasdfasdfasdfsadfadfadsfasdr' }; //"name" length must be less than or equal to 30 characters long
const user = { name: "Fo" }; // "name" length must be at least 3 characters long

// 유효성 검사 방법 1: validate()
